...
from app.bot.handlers.report_status import router as report_status_router
...
async def run_polling() -> None:
    ...
    if settings.bot_force_ipv4:
        # Some VPS networks have flaky IPv6 route to api.telegram.org.
        # Force IPv4 connector to reduce Telegram timeout errors.
    ...
    dp.include_router(report_status_router)
